...
public class ResultRunActivity extends Activity {
   ...
   ImageView imgday,imgweek,imgmonth;
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      imgday = (ImageView) findViewById(R.id.imageView_run_day1);
      ...
      imgTime.setImageBitmap(null);
        ...
        btnRunDay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
        			...
        			if(Application.getHCSAPI().GetExResult(mArrayList, mRetJson)) {
        				try {
        					...
        					for (int num = results.length(); num > 0; num--) {
        						...
        						day_run_time += Integer.parseInt(resultInfo.getString("ex_time"));
        						day_run_km += Integer.parseInt(resultInfo.getString("ex_distance"));
        						day_run_cal += Integer.parseInt(resultInfo.getString("ex_calories"));
            	...
            	imgday.setImageResource(R.drawable.day);
               if (day_run_cal == 0) {
              ...
              } else if (day_run_cal>= 701 && day_run_cal<801) {
                 imgCal.setImageResource(R.drawable.drc9);
              } else {
                 Toast.makeText(ResultRunActivity.this, "출력에 실패했습닙다", Toast.LENGTH_SHORT).show();
              }
               
               if (day_run_km == 0) {
                   imgCal.setImageResource(R.drawable.drrk1);
               } else if (day_run_km == 1) {
                  imgKm.setImageResource(R.drawable.drrk2);
               } else if (day_run_km == 2) {
            	   imgKm.setImageResource(R.drawable.drrk3);
               } else if (day_run_km == 3) {
            	   imgKm.setImageResource(R.drawable.drrk4);
               } else if (day_run_km == 4) {
            	   imgKm.setImageResource(R.drawable.drrk5);
               } else if (day_run_km == 5) {
            	   imgKm.setImageResource(R.drawable.drrk6);
               } else if (day_run_km == 6) {
            	   imgKm.setImageResource(R.drawable.drrk7);
               } else if (day_run_km == 7) {
               ...
               } else if (day_run_time >=211 && day_run_time< 241 ) {
        ...
        btnRunWeek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	imgday.setImageResource(R.drawable.week);
            	 if (day_run_cal == 0) {
                 ...
                 } else if (day_run_cal>= 2101 && day_run_cal<2401) {
                  ...
                  if (day_run_km == 0) {
                      imgCal.setImageResource(R.drawable.wrrk1);
                  } else if (day_run_km >= 1 && day_run_km < 4) {
                  ...
                  } else if (day_run_km >= 22 && day_run_km < 25) {
        ...
        btnRunMonth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	imgday.setImageResource(R.drawable.month);
            	if (day_run_cal == 0) {
                    ...
                    } else if (day_run_km >= 1 && day_run_km < 21) {
                    ...
                    } else if (day_run_km >= 141 && day_run_km < 161) {
                    ...
                    } else if (day_run_time >=2521 && day_run_time< 2881 ) {
