...
public class HCSAPI {
	...
	public static String SERVER_URL = "http://192.168.0.168//";	// http://192.168.0.168/
	...
	public static String GET_EX_LATEST_RESULT = "ict_chcs_get_latest_ex_result.php";
...
*/	
	...
	public static Boolean GetExResult(ArrayList<String> ArrayList, StringBuilder retJson) {
		...
		if (ArrayList.size() == 3) {
			REQUEST = SERVER_URL + GET_EX_RESULT + "?" + "id=" + ArrayList.get(0)
			+ "&ex_variety=" + ArrayList.get(1) + "&st_time=" + ArrayList.get(2);
			String result = null;
			try {
				result = new Query().execute(REQUEST).get();
				if(retJson != null) retJson.append(result);
...
public static Boolean GetExLatestResult(ArrayList<String> ArrayList, StringBuilder retJson) {
		
		if (ArrayList.size() == 2) {
			REQUEST = SERVER_URL + GET_EX_LATEST_RESULT + "?" + "id=" + ArrayList.get(0)
			+ "&ex_variety=" + ArrayList.get(1);
			String result = null;
			try {
				result = new Query().execute(REQUEST).get();
				if(retJson != null) retJson.append(result);
