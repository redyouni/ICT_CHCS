package com.ict_chcs.hm_t.hzgrapherlib.vo;
...
public class GraphNameBox {
	...
	public static final int DEFAULT_NAMEBOX_COLOR				= Color.TRANSPARENT;
	public static final int DEFAULT_NAMEBOX_MARGINTOP 			= 20;
	public static final int DEFAULT_NAMEBOX_MARGINRIGHT 		= 20;
	public static final int DEFAULT_NAMEBOX_PADDING 			= 10;
	public static final int DEFAULT_NAMEBOX_TEXT_SIZE			= 15;
	public static final int DEFAULT_NAMEBOX_TEXT_COLOR			= Color.LTGRAY;
	public static final int DEFAULT_NAMEBOX_ICON_WIDTH 			= 10;
